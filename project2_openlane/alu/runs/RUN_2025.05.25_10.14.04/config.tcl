...
set ::env(CURRENT_NETLIST) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/results/synthesis/alu.v"
...
set ::env(GLB_CFG_FILE) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/config.tcl"
...
set ::env(LIB_CTS) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/tmp/cts/cts.lib"
set ::env(LIB_CTS_FASTEST) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/tmp/cts/cts-fastest.lib"
set ::env(LIB_CTS_SLOWEST) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/tmp/cts/cts-slowest.lib"
...
set ::env(LIB_SYNTH) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/tmp/synthesis/trimmed.lib"
set ::env(LIB_SYNTH_COMPLETE) "/root/.volare/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib"
set ::env(LIB_SYNTH_COMPLETE_NO_PG) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/tmp/synthesis/1-sky130_fd_sc_hd__tt_025C_1v80.no_pg.lib"
set ::env(LIB_SYNTH_MERGED) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/tmp/synthesis/merged.lib"
set ::env(LIB_SYNTH_NO_PG) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/tmp/synthesis/1-trimmed.no_pg.lib"
...
set ::env(LOGS_DIR) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/logs"
...
set ::env(MERGED_LEF) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/tmp/merged.nom.lef"
set ::env(MERGED_LEF_MAX) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/tmp/merged.max.lef"
set ::env(MERGED_LEF_MIN) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/tmp/merged.min.lef"
...
set ::env(REPORTS_DIR) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/reports"
set ::env(RESULTS_DIR) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/results"
...
set ::env(RUN_CTS) "1"
set ::env(RUN_CVC) "1"
set ::env(RUN_DIR) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04"
set ::env(RUN_DRT) "1"
...
set ::env(RUN_TAG) "RUN_2025.05.25_10.14.04"
...
set ::env(START_TIME) "2025.05.25_10.14.04"
...
set ::env(TMP_DIR) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/tmp"
set ::env(TOP_MARGIN_MULT) "4"
set ::env(TRACKS_INFO_FILE) "/root/.volare/sky130A/libs.tech/openlane/sky130_fd_sc_hd/tracks.info"
set ::env(TRACKS_INFO_FILE_PROCESSED) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/tmp/routing/config.tracks"
...
set ::env(YOSYS_OUT) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/tmp/synthesis/blackbox/sky130_fd_sc_hd__blackbox.v"
set ::env(YOSYS_REWRITE_VERILOG) "0"
set ::env(cts_logs) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/logs/cts"
set ::env(cts_reports) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/reports/cts"
set ::env(cts_results) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/results/cts"
set ::env(cts_tmpfiles) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/tmp/cts"
set ::env(floorplan_logs) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/logs/floorplan"
set ::env(floorplan_reports) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/reports/floorplan"
set ::env(floorplan_results) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/results/floorplan"
set ::env(floorplan_tmpfiles) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/tmp/floorplan"
set ::env(placement_logs) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/logs/placement"
set ::env(placement_reports) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/reports/placement"
set ::env(placement_results) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/results/placement"
set ::env(placement_tmpfiles) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/tmp/placement"
set ::env(routing_logs) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/logs/routing"
set ::env(routing_reports) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/reports/routing"
set ::env(routing_results) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/results/routing"
set ::env(routing_tmpfiles) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/tmp/routing"
set ::env(signoff_logs) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/logs/signoff"
set ::env(signoff_reports) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/reports/signoff"
set ::env(signoff_results) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/results/signoff"
set ::env(signoff_tmpfiles) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/tmp/signoff"
set ::env(synth_report_prefix) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/reports/synthesis/1-synthesis"
set ::env(synthesis_logs) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/logs/synthesis"
set ::env(synthesis_reports) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/reports/synthesis"
set ::env(synthesis_results) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/results/synthesis"
set ::env(synthesis_tmpfiles) "/openlane/designs/alu/runs/RUN_2025.05.25_10.14.04/tmp/synthesis"
set ::env(timer_end) "1748168048"
set ::env(timer_start) "1748168044"
